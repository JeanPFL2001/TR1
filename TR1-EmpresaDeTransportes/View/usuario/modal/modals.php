                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="date" class="form-control shadow" id="agregar-boleto-venta-fecha-viaje">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="mb-2 d-flex ">
                            <div class="mb-1" style="width: 15%; padding: 0 10px 0 10px;">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-info shadow" value="info" data-bs-toggle="modal" data-bs-target="#seleccionar-cliente-venta" onclick="cargarClientes(this);"><i class="fa-solid fa-person-walking-luggage"></i></button>
                                </div>
                            </div>
                            <div class="mb-1" style="width: 30%; padding: 0 10px 0 10px;">
                        ...
                        <div class="mb-2 d-flex ">
                            ...
                            <div class="mb-1" style="width: 20%; padding: 0 10px 0 10px;">
                                ...
                                <select type="text" class="form-select shadow" id="info-venta-tipo-pago">
                                    <option value="TARJETA" selected>Tarjeta</option>
                                    <option value="YAPE">Yape</option>
                                    <option value="TUNKI">Tunki</option>
                                    <option value="PLIN">Plin</option>
                            ...
                            <div class="mb-1" style="width: 25%; padding: 0 10px 0 10px;">
                                <label for="info-venta-hora-registro" class="col-form-label"><b>Hora de Registro</b></label>
                                <input type="text" class="form-control shadow" id="info-venta-hora-registro" readonly>
                            </div>
                            <div class="mb-1" style="width: 25%; padding: 0 10px 0 10px;">
                        ...
                        <div class="w-100 d-flex ">
                            <h5><b>Boletos</b></h5>
                            <div class="d-flex offset-md-9">
                                <button id="btn-info-boleto-venta" class="btn btn-info" style="margin: 10px;" value="0" data-bs-toggle="modal" data-bs-target="#agregar-boleto-venta" disabled>Agregar</button>
                            </div>
                        </div>
                        <div class="card">
                            <div class="table-responsive " style="height: 30vh;">
