        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-slide-to="2" data-target="#secciones">Contactanos</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block" style=" bottom:20%; color: white; border: 2px solid white; border-radius:10px; background-color: rgba(0,0,0,0.5);">
                    ...
                    <h3><b>-La capacidad de registrar tu boletos a cualquier hora y en cualquier lugar.</b></h4>
                        <h3><b>-Editar tus boletos de manera rápida y con 0 costo adicional.</b></h3>
                        <h3><b>-Una gran variedad de destinos en todo el Perú a los mejores precios.</b></h3>
                        <h3><b>-Distintos metodos de pago como Yape, Izipay, entre otros.</b></h3>
                        <h2 class="pd-3"><b> !Olvidate de hacer colas y viaja rapidamente¡</b></h2>
                </div>
            </div>
            <div class="carousel-item">
